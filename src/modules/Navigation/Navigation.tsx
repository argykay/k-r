...
const NAV_ROUTES: { route: RouteId; labelKey: 'navigation.home' | 'navigation.ourStory' | 'navigation.details' | 'navigation.rsvp' }[] = [
  { route: 'home', labelKey: 'navigation.home' },
  { route: 'ourStory', labelKey: 'navigation.ourStory' },
